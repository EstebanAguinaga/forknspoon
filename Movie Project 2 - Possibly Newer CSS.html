...
.whatiscyberbtn:hover{
    background-color: black;
    color: yellow;
}

.whatiscyberbtncont:hover{
    background-color: black;
    color: yellow;
}
...
<div class="titlepic">
    ...
    <div class="cyberflat">
        <header>
            <div class="glitch" data-text="CYBERPUNK_" style="font-size: 150px;">CYBERPUNK_</div>
        </header>
    </div>
</section>
<section>
    <div>
        ...
        <p class="glitch2" data-text="What is Cyberpunk?_">What is Cyberpunk?</p>
    ...
    <div>
        <button class="whatcyberbtn" onclick="document.location='#home'" style="font-family: 'Orbitron', sans-serif;">
                    <span class="whatiscyberbtncont"><i class="fas fa-angle-double-up" style="font-size: 24px; position: relative; left: 35%;"></i></span></button>
    </div>
</section>
<div>
		<section class="movies">
		  <h1 class="glitch2" data-text="MOVIES_"id="movies" style="top: 200%">MOVIES_</h1>
